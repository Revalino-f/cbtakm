...
$mapel = mysqli_fetch_array(mysqli_query($koneksi, "select * from mapel,mata_pelajaran where mapel.nama=mata_pelajaran.kode_mapel and id_mapel='$id_mapel'"));
if ($mapel['idpk'] == '0') {
...
<td width=2000>Mata Pelajaran </td>
			<td width=2000>: <?= $mapel['nama_mapel'] ?> </td>
		...
		<table width=100% border=0>
			<tr>
				...
				if ($sp['file'] <> '') {
					...
					<audio controls>
						<source src='$homeurl/files/$sp[file]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
					";
					} else {
				...
				if ($sp['file1'] <> '') {
					...
					if (in_array($ext, $image)) {
						...
						<audio controls>
							<source src='$homeurl/files/$sp[file1]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
						";
					} else {
						echo "File tidak didukung!";
					}
		...
		<tr>
			...
			<td width=300px colspan=2 valign=top>
				$Jawab1 <br>";
					...
					<audio controls>
						<source src='$homeurl/files/$sp[fileA]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
					";
						} else {
							echo "File tidak didukung!";
						}
			...
			<td width=300px colspan=2 valign=top>
				$Jawab3 <br>";
					...
					<audio controls>
						<source src='$homeurl/files/$sp[fileC]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
					";
						} else {
							echo "File tidak didukung!";
						}
			...
			<td width=300px colspan=2 valign=top>
				$Jawab5 <br>";
					...
					<audio controls>
						<source src='$homeurl/files/$sp[fileE]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
					";
							} else {
								echo "File tidak didukung!";
							}
		...
		<tr>
			...
			<td width=300px colspan=2>
				$Jawab2 <br>";
					...
					<audio controls>
						<source src='$homeurl/files/$sp[fileB]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
					";
						} else {
							echo "File tidak didukung!";
						}
			...
			";
				...
				<td width=300px colspan=2>
					$Jawab4 <br>";
						...
						<audio controls>
							<source src='$homeurl/files/$sp[fileD]' type='audio/$ext'>Your browser does not support the audio tag.</audio>
						";
							} else {
								echo "File tidak didukung!";
							}
