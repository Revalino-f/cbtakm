                    ...
                    <tr>
                        ...
                        <td>
							...
							if ($mapel['peringkat'] == 1) {
                                echo "<span class='badge bg-green' data-toggle='tooltip' data-placement='top' title='peringkat yes'>Y</span> ";
                            } elseif ($mapel['peringkat'] == 0) {
                                echo "<span class='badge bg-red' data-toggle='tooltip' data-placement='top' title='peringkat no'>N</span> ";
                            }
                            if ($mapel['ulang'] == 1) {
