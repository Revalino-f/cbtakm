...
<?php elseif ($pg == 'beritaujian') : ?>
    <?php include 'mod_berita/prev_berita_ujian.php'; ?>
...
<?php elseif ($pg == 'rekapakm') : ?>
    <!--    <?php cek_session_guru(); ?> -->
    <?php include 'mod_akm/rekapakm.php'; ?>
<?php elseif ($pg == 'importguru') : ?>
    <?php
    cek_session_admin(); ?>
    <?php include 'mod_guru/import.php'; ?>
	<!-- /.sandik AKM -->
<?php elseif ($pg == 'setting_soal') : ?>
    <?php cek_session_admin(); ?>
    <?php include 'mod_akm/setting_soal.php'; ?>	
<?php elseif ($pg == 'bankakm') : ?>
    <?php include 'mod_akm/banksoal.php'; ?>		
<?php elseif ($pg == 'editsoal3') : ?>
    <?php include "mod_akm/editsoal3.php"; ?>	
	<?php elseif ($pg == 'editsoal1') : ?>
    <?php include "mod_akm/editsoal1.php"; ?>	
	<?php elseif ($pg == 'editsoal2') : ?>
    <?php include "mod_akm/editsoal2.php"; ?>	
	<?php elseif ($pg == 'editsoal4') : ?>
    <?php include "mod_akm/editsoal4.php"; ?>	
	<?php elseif ($pg == 'editsoal5') : ?>
    <?php include "mod_akm/editsoal5.php"; ?>	
	<?php elseif ($pg == 'editsoal6') : ?>
    <?php include "mod_akm/editsoal6.php"; ?>	
	<?php elseif ($pg == 'editsoal7') : ?>
    <?php include "mod_akm/editsoal7.php"; ?>	
	
	<?php elseif ($pg == 'statusakm') : ?>
     <?php include "status/statusakm_peserta.php"; ?>
	<?php elseif ($pg == 'nilaiujianakm') : ?>
    <?php include "mod_akm/nilaiujian2.php"; ?>	
	<?php elseif ($pg == 'semuanilai') : ?>
    <?php include "mod_akm/semuanilai.php"; ?>	
	<?php elseif ($pg == 'analisis') : ?>
    <?php include 'analisis/nilaianalisis2.php'; ?>		
	<?php elseif ($pg == 'jadwalakm') : ?>
    <?php include "mod_akm/jadwal.php"; ?>	
