								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='A' <?= $jwbA ?> /> Pilihan A</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='B'  $jwbB /> Pilihan B</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' name='jawaban[]' value='C'  $jwbC /> Pilihan C</label>
											</div>
										</div>
									...
									";
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label><input type='checkbox' name='jawaban[]' value='D'  $jwbD /> Pilihan D</label>
												</div>
											</div>
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label><input type='checkbox' name='jawaban[]' value='E'  $jwbE /> Pilihan E</label>
												</div>
											</div>
