			 ...
			 <h4 class='box-title'></h4>
			  ...
			  <div class="box-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true" >Input Soal</a></li>
                    </ul>
		...
		<form id='formsoal' action='' method='post' enctype='multipart/form-data'>
			<div class='box box-solid'>
				...
				<div class='box-body'>
					...
					<input type='hidden' name='kode' value='FO'>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabana' value='F' required='true' <?= $jwbA ?> /> Fakta</label> <label style='color:red'><input type='radio' name='jawabana' value='O' required='true' <?= $jwbA ?> /> Opini</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanb' value='F' required='true' $jwbB /> Fakta</label> <label style='color:red'><input type='radio' name='jawabanb' value='O' required='true' $jwbB /> Opini</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanc' value='F' required='true' $jwbC /> Fakta</label> <label style='color:red'><input type='radio' name='jawabanc' value='O' required='true' $jwbC /> Opini</label>
											</div>
										</div>
									...
									";
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label style='color:blue'><input type='radio' name='jawaband' value='F' required='true' $jwbD /> Fakta</label> <label style='color:red'><input type='radio' name='jawaband' value='O' required='true' $jwbD /> Opini</label>
												</div>
											</div>
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label style='color:blue'><input type='radio' name='jawabane' value='F' required='true' $jwbE /> Fakta</label> <label style='color:red'><input type='radio' name='jawabane' value='O' required='true' $jwbE /> Opini</label>
												</div>
											</div>
