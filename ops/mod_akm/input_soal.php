			...
			<div class='box box-solid'>
				<div class='box-header with-border'>
					...
					<div class='box-tools pull-right btn-group'>
						...
						<a href='?pg=bankakm&ac=lihat&id=<?= $id_mapel ?>' class='btn btn-sm btn-danger'><i class='fa fa-times'></i></a>
				...
				<div class='box-body'>
					...
					<div class='row'>
						...
						<?php } ?>
						<?php if($jenis==2){ ?>
						<h4 class='box-title'>SOAL ISIAN SINGKAT</h4>
						<?php } ?>
					 ...
					 <?php if ($jenis == '2') : ?>
						<div class='col-md-6'>
                            ...
                            <textarea id='jawabesai' name='pilA' style='height:200px' class='form-control' ><?= $soal['pilA'] ?></textarea>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawaban' value='A' required='true' <?= $jwbA ?> /> Pilihan A</label>
											</div>
										</div>
										<div id='collapseOne' class='panel-collapse collapse' aria-expanded='false' style='height: 0px;'>
											<div class='box-body'>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawaban' value='B' required='true' $jwbB /> Pilihan B</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawaban' value='C' required='true' $jwbC /> Pilihan C</label>
											</div>
										</div>
									...
									";
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label style='color:blue'><input type='radio' name='jawaban' value='D' required='true' $jwbD /> Pilihan D</label>
												</div>
											</div>
										...
										<div class='panel box box-solid'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right'>
													<label style='color:blue'><input type='radio' name='jawaban' value='E' required='true' $jwbE /> Pilihan E</label>
												</div>
											</div>
