		...
		<form id='formsoal2' action='' method='post' enctype='multipart/form-data'>
			<div class='box box-solid'>
				...
				<div class='box-body'>
					...
					<div class='row'>
						<div class='col-md-6'>
						<h4 class='box-title'>SOAL PG MULTI CHOICE</h4>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('A', $checked) ? print "checked" : ""; ?> name='jawaban[]' value='A' /> Pilihan A</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('B', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='B' > Pilihan B</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('C', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='C' > Pilihan C</label>
											</div>
										</div>
			                        ...
			                        <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('D', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='D' > Pilihan D</label>
											</div>
										</div>
								 ...
								 <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label><input type='checkbox' <?php in_array ('E', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='E' > Pilihan D</label>
											</div>
										</div>
