			...
			<div class='box box-solid'>
				<div class='box-header with-border'>
					...
					<div class='btn-group' style='margin-top:-5px'>
						<a class='btn btn-sm btn-secondary'>Mapel </a>
				...
				<div class='box-body'>
					...
					<div class='row'>
						<div class='col-md-6'>
							<h4 class='box-title'>SOAL PG FAKTA OPINI</h4>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabana' <?php if($checked[0]=='F'){echo "checked"; } ?>  value='F' required='true' /> Fakta</label>
												<label style='color:red'><input type='radio' name='jawabana'  <?php if($checked[0]=='O'){echo "checked"; } ?>  value='O' required='true' /> Opini</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanb' <?php if($checked[1]=='F'){echo "checked"; } ?>  value='F' required='true'  /> Fakta</label>
												<label style='color:red'><input type='radio' name='jawabanb' <?php if($checked[1]=='O'){echo "checked"; } ?>  value='O' required='true' /> Opini</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanc' <?php if($checked[2]=='F'){echo "checked"; } ?>  value='F' required='true'  /> Fakta</label>
												<label style='color:red'><input type='radio' name='jawabanc' <?php if($checked[2]=='O'){echo "checked"; } ?>  value='O' required='true' /> Opini</label>
											</div>
										</div>
			                        ...
			                        <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawaband' <?php if($checked[3]=='F'){echo "checked"; } ?>  value='F' required='true'  /> Fakta</label>
												<label style='color:red'><input type='radio' name='jawaband' <?php if($checked[3]=='O'){echo "checked"; } ?>  value='O' required='true' /> Opini</label>
											</div>
										</div>
								 ...
								 <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabane' <?php if($checked[4]=='F'){echo "checked"; } ?>  value='F' required='true'  /> Fakta</label>
												<label style='color:red'><input type='radio' name='jawabane' <?php if($checked[4]=='O'){echo "checked"; } ?>  value='O' required='true' /> Opini</label>
											</div>
										</div>
