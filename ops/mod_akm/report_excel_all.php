...
$id_kelas = $_GET['k'];
$pengawas = fetch($koneksi, 'users', array('id_pengawas' => $id_pengawas));
$mapel = fetch($koneksi, 'banksoal', array('id_bank' => null));
	...
	<thead>
		<tr>
			...
			while ($mapel = mysqli_fetch_array($mapelQ)) :
				echo "<th style='text-align:center' colspan='1'>$mapel[nama]</th>";
			endwhile;
			?>
		</tr>
		<tr>
			...
			while ($mapel = mysqli_fetch_array($kode)) :
				echo "<th style='text-align:center' colspan='1'>$mapel[kode_ujian]</th>";
			endwhile;
			?>
		</tr>
		<tr>
		...
		<?php while ($siswa = mysqli_fetch_array($siswaQ)) : ?>
			...
			<tr>
				...
				<?php while ($mapel = mysqli_fetch_array($mapelQ)) : ?>
					...
					<td style="text-align:center" class='str'><?= $nilai['total'] ?></td>
				<?php endwhile; ?>
			</tr>
		<?php endwhile; ?>
	</tbody>
