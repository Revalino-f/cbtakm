		...
		<form id='formsoal2' action='' method='post' enctype='multipart/form-data'>
			<div class='box box-solid'>
				...
				<div class='box-body'>
					...
					<input type='text' name='mapel' value='<?= $nomor['id_mapel'] ?>'>
								...
								<div class='box-group' id='accordion'>
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabana' <?php if($checked[0]=='B'){echo "checked"; } ?>  value='B' required='true' /> Benar</label>
												<label style='color:red'><input type='radio' name='jawabana'  <?php if($checked[0]=='S'){echo "checked"; } ?>  value='S' required='true' /> Salah</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanb' <?php if($checked[1]=='B'){echo "checked"; } ?>  value='B' required='true'  /> Benar</label>
												<label style='color:red' ><input type='radio' name='jawabanb' <?php if($checked[1]=='S'){echo "checked"; } ?>  value='S' required='true' /> Salah</label>
											</div>
										</div>
									...
									<div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabanc' <?php if($checked[2]=='B'){echo "checked"; } ?>  value='B' required='true'  /> Benar</label>
												<label style='color:red'><input type='radio' name='jawabanc' <?php if($checked[2]=='S'){echo "checked"; } ?>  value='S' required='true' /> Salah</label>
											</div>
										</div>
			                        ...
			                        <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawaband' <?php if($checked[3]=='B'){echo "checked"; } ?>  value='B' required='true'  /> Benar</label>
												<label style='color:red'><input type='radio' name='jawaband' <?php if($checked[3]=='S'){echo "checked"; } ?>  value='S' required='true' /> Salah</label>
											</div>
										</div>
								 ...
								 <div class='panel box box-solid'>
										<div class='box-header with-border'>
											...
											<div class='box-tools pull-right'>
												<label style='color:blue'><input type='radio' name='jawabane' <?php if($checked[4]=='B'){echo "checked"; } ?>  value='B' required='true'  /> Benar</label>
												<label style='color:red'><input type='radio' name='jawabane' <?php if($checked[4]=='S'){echo "checked"; } ?>  value='S' required='true' /> Salah</label>
											</div>
										</div>
