...
$lebarusername = '10%';
$lebarnopes = '17%';
$mapelx = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM banksoal WHERE id_bank='$qujian[id_bank]'"));
...
<?php for ($i = 1; $i <= $n; $i++) : ?>
    ...
    <?php if ($i == $n) : ?>
        <div class='page'>
            <table width='100%'>
                <tr>
                    <td width='100'><img src='<?php echo $homeurl . '/dist/img/diknas.png' . '?date=' . time(); ?>' width='80'></td>
