                            ...
                            <tbody>
                                <tr>
                                    <td>
										...
										<small class='label bg-blue'><?= $namamapel['groupsoal'] ?></small>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <b>Jumlah Soal</b><br />
                                        <small class='label bg-purple'><?= $namamapel['tampil_pg'] . ' PG / ' . $namamapel['tampil_multi'] . ' Multi / ' . $namamapel['tampil_bs'] . ' BS / ' . $namamapel['tampil_urut'] . ' Urut / '.$namamapel['tampil_esai'] ?> Esai</small>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
